...
# FIX: Aggiunti \" attorno a {RELEASE_DIR} per proteggere lo spazio!
deploy_cmd = (
...
# FIX: Aggiunti \" attorno alla destinazione
...
if os.path.exists(sh_file):
    ...
    print(f"ATTENZIONE: {sh_file} non trovato.")
